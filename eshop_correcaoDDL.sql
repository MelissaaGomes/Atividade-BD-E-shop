...
-- Os comandos DML (insert / select) permitem inserir dados em uma tabela, desta forma, devemos inserir dados em todas as colunas(ou as especificadas), respeitando a ordem delas.
